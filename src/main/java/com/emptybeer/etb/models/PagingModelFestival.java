...
public class PagingModelFestival {
    ...
    public PagingModelFestival(int totalCount, int requestPage) {
        this(9, totalCount, requestPage);
    }

    public PagingModelFestival(int countPerPage, int totalCount, int requestPage) {
