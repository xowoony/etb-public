...
public class PagingModelBeer {
    ...
    public PagingModelBeer(int totalCount, int requestPage) {
        this(9, totalCount, requestPage);
    }

    public PagingModelBeer(int countPerPage, int totalCount, int requestPage) {
